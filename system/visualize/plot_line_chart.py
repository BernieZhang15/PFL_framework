...
plt.plot(bin_centers, bin1, marker='o', label='FedAvg', linewidth=3, color="#2E86C1")
plt.plot(bin_centers, bin2, marker='o', label='per-FedAvg', linewidth=3, color="#EF767A")
plt.plot(bin_centers, bin3, marker='o', label='pFedBayes', linewidth=3, color="#456990")
plt.plot(bin_centers, bin4, marker='o', label='Ours', linewidth=3, color="#48C0AA")
