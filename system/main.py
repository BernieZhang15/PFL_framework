...
from flcore.trainmodel.Bayes_Resnet import *
from flcore.trainmodel.FourierFTModel import *
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        elif args.algorithm == "FedFourierFT":
            server = FedFourierFT(args, i)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ls', "--local_epochs", type=int, default=20, help="Multiple update steps in one local epoch.")
    ...
    parser.add_argument('-lrp', "--p_learning_rate", type=float, default=0.005, help="personalized learning rate")
