...
CSV_PATH = BASE_DIR / "summary_Cifar100-pat-5M.csv"
OUT_PATH = BASE_DIR / "cifar100_fr_plot.pdf"
...
# Compute x-axis as #parameters x 10^3
...
ax.plot(x_params_k, mean_pct, linewidth=2, color="#1f77b4")
ax.fill_between(
    x_params_k,
...
ax.set_title("CIFAR-100 5/100")

# X ticks every 0.4
x_min = math.floor(min(x_params_k) / 0.4) * 0.4
x_max = math.ceil(max(x_params_k) / 0.4) * 0.4
